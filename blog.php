...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="blog">
		...
		<div id="main"><?php if($GLOBALS["enable_notifications"] == true) include ("notification_system.inc.php"); ?>
			<?php
			...
			?>
			<form method="post" id="article_form" action="engine.php?action=<?php echo $p == "add" ? "add_article" : "mod_article";?><?php if(isset($_GET["id"])) echo "&amp;id=".$_GET["id"]; ?>" enctype="plain/text">
				<p>
			...
			<?php
				...
				break;
				default:
					echo "<p>wait, what? that shouldn't be a get value?</p>";
				break;
			}
			?>
		</div>
