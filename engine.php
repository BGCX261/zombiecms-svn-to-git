	...
	else if($_SESSION["logged"] == true) /*Logged in*/
	{
		...
		switch($_GET["action"])
		{
			case "mod_prefs":
				...
				$theme = $_POST["theme"];
				$mod = mysql_query("UPDATE zombie_settings SET enable_logging='$enable_logging', enable_notifications='$enable_notifications', menu_type='$menu_type', theme='$theme' WHERE user_id='$id';");
