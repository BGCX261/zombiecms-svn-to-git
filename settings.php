...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="settings">
		<div id="top">
			...
			<div id="quickboard">
				<a href="search.php"><img src="images/icons/search.png" alt="search" /></a><a href="settings.php"><img src="images/icons/settings.png" alt="settings" /></a><a href="#empty"><img src="images/icons/about.png" alt="about" /></a><a href="log.php?dir=out"><img src="images/icons/logout.png" alt="logout" /></a>
			</div>
			<div id="menu">
				<?php include ("zombie_menu.inc.php"); ?>
			</div>
		</div>
		<div id="main"><?php if($GLOBALS["enable_notifications"]) include ("notification_system.inc.php"); ?>
			<div class="col">
				<form method="post" action="engine.php?action=mod_prefs" enctype="plain/text">
					<h2>Preferences</h2>
					<p>
						<?php $prefs = mysql_fetch_array(mysql_query("SELECT enable_logging, enable_notifications, theme, menu_type FROM zombie_settings WHERE user_id='".$_SESSION['id']."' LIMIT 1")); ?>
			...
			<div class="col">
				<form method="post" action="engine.php?action=mod_settings" enctype="plain/text">
					<h2>Settings</h2>
					<p>
