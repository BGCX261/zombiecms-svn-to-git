		...
		<div id="main">
			...
			<div class="col">
				...
				<?php if(isset($_GET["id"])) { ?><div class="tabbed_content back_blue" id="content_mod_tab">
					<form method="post" action="engine.php?action=mod_root&amp;id=<?php echo $_GET["id"]; ?>" enctype="plain/text">
				...
				<div class="tabbed_content back_blue" id="content_add_tab">
					<form method="post" action="engine.php?action=add_root" enctype="plain/text" id="add_root_form">
				...
				<div class="tabbed_content back_blue" id="content_search_tab">
					<form method="get" action="search.php?type=root" enctype="plain/text" id="search_root_form">
